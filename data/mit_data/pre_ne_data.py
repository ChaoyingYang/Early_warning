...
path1 = './data/.../2017-05-12_batchdata_updated_struct_errorcorrect.mat' # data fron offical
...
def get_xy(cyc_num):
    ...
    for i in cyc_num:
        ...
        label.update({key:aux_lbl})
    return label

# label = get_xy(cycle_train)
# save_obj(label,'./data/ne_data/label_train')

# label = get_xy(cycle_test)
# save_obj(label,'./data/ne_data/label_test')

# label = get_xy(cycle_secondary)
